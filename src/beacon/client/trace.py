...
the_dsn = os.getenv("beacon_TELEMETRY", "https://7023ec3e0699da14a8013478e50b9142@o4508336623583232.ingest.us.sentry.io/4508607159599104")
...
sentry_sdk_.init(
    ...
    release=f"beacon@{get_library_version()}",
    server_name="beacon_client",
