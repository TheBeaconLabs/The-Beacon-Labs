...
from .client.base import beaconClient
...
def hello() -> str:
    return "Hello from beacon!"


__all__ = ["hello", "beaconClient", "ObjectResponse", "StrResponse", "IntResponse", "FloatResponse", "BoolResponse", "Task", "StrInListResponse", "AgentConfiguration", "Field", "KnowledgeBase", "ClientConfig", "Agent", "Direct", "MultiAgent"]
