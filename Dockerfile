...
RUN mkdir /home/docker/beacon
COPY beacon /home/docker/beacon
...
RUN python3.12 -m pip install /home/docker/beacon[server]



ADD beacon/wallpaper.png /home/docker/Pictures/wallpaper.png
